...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/types-backports_abc-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13138&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/types-backports_abc-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `types-backports_abc` can be installed with:

```
conda install types-backports_abc
```

It is possible to list all of the versions of `types-backports_abc` available on your platform with:
